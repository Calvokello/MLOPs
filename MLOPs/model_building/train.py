...
# MLflow local server started by the GitHub Actions workflow
mlflow.set_tracking_uri("http://127.0.0.1:5000")

# IMPORTANT: use the SAME experiment name used in your development experimentation cell
...
with mlflow.start_run():
    ...
    # Save model next to app.py
    model_path = "MLOPs/deployment/model.pkl"
